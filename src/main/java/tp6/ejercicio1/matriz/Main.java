...
public class Main {
    public static void main(String[] args) {
        ...
        grafoImplMatrizAdy.agregarVertice(new VerticeImplListAdy<>(1));
        grafoImplMatrizAdy.agregarVertice(new VerticeImplListAdy<>(2));
        grafoImplMatrizAdy.agregarVertice(new VerticeImplListAdy<>(3));
        grafoImplMatrizAdy.agregarVertice(new VerticeImplListAdy<>(4));
        grafoImplMatrizAdy.agregarVertice(new VerticeImplListAdy<>(5));
